...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1018.0, 406.64155125617981, 66.0, 22.0 ],
					"text" : "setOffset 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.914994657039642, 518.43372654914856, 66.0, 22.0 ],
					"text" : "setNotes 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1314.893607616424561, 124.468084216117859, 39.0, 22.0 ],
					"text" : "port a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.189012467861176, 245.512194395065308, 72.0, 22.0 ],
					"text" : "listenAscii 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.043651759624481, 245.512194395065308, 72.0, 22.0 ],
					"text" : "listenAscii 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 968.716803550720215, 240.0, 72.0, 22.0 ],
					"text" : "listenAscii 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 890.571442842483521, 240.0, 72.0, 22.0 ],
					"text" : "listenAscii 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 566.716803550720215, 261.0, 72.0, 22.0 ],
					"text" : "listenAscii 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 488.571442842483521, 261.0, 72.0, 22.0 ],
					"text" : "listenAscii 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.14084666967392, 608.846220016479492, 110.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 921.14084666967392, 608.846220016479492, 110.0, 22.0 ],
					"text" : "setScale chromatic"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1237.410063505172729, 57.095237255096436, 50.0, 36.0 ],
					"text" : "setPedal 0"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1183.082936644554138, 51.0, 1277.910063505172729, 51.0 ],
					"order" : 0,
					"source" : [ "obj-113", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 930.64084666967392, 633.0, 900.0, 633.0, 900.0, 429.0, 930.029745101928711, 429.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1163.082936644554138, 156.0, 1277.910063505172729, 156.0 ],
					"order" : 0,
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 1247.082936644554138, 156.0, 1178.082936644554138, 156.0 ],
					"source" : [ "obj-4", 1 ]
				}
